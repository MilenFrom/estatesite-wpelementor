        ...
        const initListener = ($scope) => {
            ...
            try {
                ...
                switch (name) {
                    ...
                    case 'houzez-elementor-nav-menu':
                    case 'nav-menu':
                        
                        // Adjust mega menu positioning for Elementor editor
                        // setTimeout(function() {
                        //     if (typeof houzez !== 'undefined' && typeof houzez.ElementorMobileMenu !== 'undefined') {
                        //         houzez.ElementorMobileMenu.adjustMegaMenu(
