...
class Houzez_Elementor_Agent_Card extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'column_view',
            [
                'label' => esc_html__('Column View', 'houzez-theme-functionality'),
    ...
    protected function render() {
        ...
        if ( 'auto' === $agent_source ) {
            ...
            global $post;
            $agent_display_option = \EstateSite\Core\Property::get( $post->ID, 'agent_display_option' );

            if ( $agent_display_option == 'agency_info' ) {
                $agent_id = \EstateSite\Core\Property::get( $post->ID, 'agency' );
            } else if ( $agent_display_option == 'agent_info' ) {
                $agent_id = \EstateSite\Core\Property::get( $post->ID, 'agents' );
            } else {
        ...
        if ( !empty( $agent_id ) && $agent_id != '-1' && get_post_status($agent_id) == 'publish' ) {
            ...
            if ( $agent_type == 'houzez_agency' ) {
                ...
                $office_phone = get_post_meta( $agent_id, 'fave_agency_phone', true ) /* TODO unmapped fave_ key: fave_agency_phone */;
                $mobile_phone = get_post_meta( $agent_id, 'fave_agency_mobile', true ) /* TODO unmapped fave_ key: fave_agency_mobile */;
                $whatsapp = get_post_meta( $agent_id, 'fave_agency_whatsapp', true ) /* TODO unmapped fave_ key: fave_agency_whatsapp */;
                $telegram = get_post_meta( $agent_id, 'fave_agency_telegram', true ) /* TODO unmapped fave_ key: fave_agency_telegram */;
                $lineapp = get_post_meta( $agent_id, 'fave_agency_line_id', true ) /* TODO unmapped fave_ key: fave_agency_line_id */;
                $email = get_post_meta( $agent_id, 'fave_agency_email', true ) /* TODO unmapped fave_ key: fave_agency_email */;
                $verified = get_post_meta( $agent_id, 'fave_agency_verified', true ) /* TODO unmapped fave_ key: fave_agency_verified */;
                ...
                $name = get_the_title($agent_id);
                $office_phone = get_post_meta( $agent_id, 'fave_agent_office_num', true ) /* TODO unmapped fave_ key: fave_agent_office_num */;
                $mobile_phone = get_post_meta( $agent_id, 'fave_agent_mobile', true ) /* TODO unmapped fave_ key: fave_agent_mobile */;
                $whatsapp = get_post_meta( $agent_id, 'fave_agent_whatsapp', true ) /* TODO unmapped fave_ key: fave_agent_whatsapp */;
                $telegram = get_post_meta( $agent_id, 'fave_agent_telegram', true ) /* TODO unmapped fave_ key: fave_agent_telegram */;
                $lineapp = get_post_meta( $agent_id, 'fave_agent_line_id', true ) /* TODO unmapped fave_ key: fave_agent_line_id */;
                $verified = get_post_meta( $agent_id, 'fave_agent_verified', true ) /* TODO unmapped fave_ key: fave_agent_verified */;
                $email = get_post_meta( $agent_id, 'fave_agent_email', true ) /* TODO unmapped fave_ key: fave_agent_email */;
                $office_phone_call = str_replace(array('(',')',' ','-'),'', $office_phone);
                $mobile_phone_call = str_replace(array('(',')',' ','-'),'', $mobile_phone);
                $permalink = get_post_permalink( $agent_id );
                ...
                $office_phone = \EstateSite\Core\Property::get( $agent_id, 'phone', null, 'user' );
                $office_phone_call = str_replace(array('(',')',' ','-'),'', $office_phone);
                $mobile_phone = \EstateSite\Core\Property::get( $agent_id, 'mobile', null, 'user' );
                $mobile_phone_call = str_replace(array('(',')',' ','-'),'', $mobile_phone);
                $whatsapp = \EstateSite\Core\Property::get( $agent_id, 'whatsapp', null, 'user' );
                $telegram = \EstateSite\Core\Property::get( $agent_id, 'telegram', null, 'user' );
                $lineapp = \EstateSite\Core\Property::get( $agent_id, 'line_id', null, 'user' );
                $photo_url = \EstateSite\Core\Property::get( $agent_id, 'custom_picture', null, 'user' );
            ...
            <div class="agent-information-module">
                <div class="property-form-wrap border-none" role="complementary">
                    <div class="agent-details" role="region">
                        <div class="d-flex align-items-start gap-3 <?php echo $column_view;?>">
