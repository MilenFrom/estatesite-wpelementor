...
class Houzez_Elementor_Search_Builder extends \Elementor\Widget_Base {
    ...
    protected function render() {
        ...
        <style>
            #houzez-search-<?php echo esc_attr($this->get_id()); ?> .houzez-ele-search-form-wrapper {
        ...
        <form class="houzez-search-form-js houzez-search-builder-form-js" id="houzez-search-<?php echo esc_attr($this->get_id()); ?>" method="get" action="<?php echo esc_url( houzez_get_search_template_link() ); ?>" <?php echo $this->get_render_attribute_string( 'form' ); ?>>
            ...
            <div class="houzez-search-builder-wrapper">
                ...
                <div <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>
                    ...
                    if ($enable_collapse && !empty($collapsed_fields)) { 
                        ...
                        <div class="<?php echo esc_attr($advanced_button_classes); ?>">
                            ...
                            <a class="elementor-button advanced-search-btn elementor-size-<?php echo esc_attr($settings['advanced_button_size']); ?> w-100 d-block text-center" data-bs-toggle="collapse" href="#advanced-search-filters-<?php echo esc_attr($this->get_id()); ?>">
                            ...
                            <button class="elementor-button btn advanced-search-btn w-100 elementor-size-<?php echo esc_attr($settings['advanced_button_size']); ?>" 
                                    ...
                                    data-bs-target="#advanced-search-filters-<?php echo esc_attr($this->get_id()); ?>"
                                    aria-expanded="false"
                ...
                <div id="advanced-search-filters-<?php echo esc_attr($this->get_id()); ?>" class="collapse <?php echo esc_attr($collapse_class); ?>">
    ...
    public function houzez_get_attribute_id( $item ) {
        return 'form-field-' . esc_attr($item['_id']);
    }
            ...
            [
                'field-group' . $i => [
                    'class' => [
                        ...
                        'elementor-column',
                        'form-group',
                        'elementor-field-group-' . esc_attr($item['_id']),
                    ],
                ],
                'input' . $i => [
