...
class Property_Toparea_v2 extends Widget_Base {
	...
	protected function register_controls() {
        ...
        //     'toparea_height',
        //     [
        //         'label' => __( 'Top Area Height', 'houzez-theme-functionality' ),
        ...
        //         ],
        //         'selectors' => [
        //             '{{WRAPPER}} .property-detail-v2 .tab-pane' => 'max-height: {{SIZE}}{{UNIT}}',
        //         ],
        //     ]
        // );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .page-title-wrap .page-title, .mobile-property-title .page-title' => 'margin-bottom: {{SIZE}}{{UNIT}} !important;',
                ],
            ]
        );
	...
	protected function render() {
        ...
        $map_street_view = \EstateSite\Core\Property::get( $post->ID, 'map_street_view' );

        $images_ids = get_post_meta( $post->ID, \EstateSite\Core\Property::key( 'images' ), false );
            ...
            <div class="property-top-wrap">
                <div class="property-banner property-banner-v2">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane show active" id="pills-gallery" role="tabpanel" aria-labelledby="pills-gallery-tab" style="background-image: url(<?php echo esc_url($featured_image_url); ?>);">
                            ...
                            if( $gallery_type == 'photoswipe' ) { ?>
                                <div>
                                    <a href="#" class="property-banner-trigger position-absolute top-0 start-0 w-100 h-100" data-src="<?php echo esc_url($featured_image_url); ?>" data-houzez-fancybox data-fancybox="gallery-v2" role="button"></a>
                                    ...
                                    if(!empty($images_ids)) {
                                        foreach( $images_ids as $image_id ) {
                                            ...
                                            <div class="gallery-hidden">
                                                <a href="#" data-src="<?php echo esc_url($image_url); ?>" data-houzez-fancybox data-fancybox="gallery-v2">
                            ...
                            <a class="property-banner-trigger position-absolute top-0 start-0 w-100 h-100" data-bs-toggle="modal" data-bs-target="#property-lightbox" href="#"></a>
                            <?php } ?>
                        </div>
