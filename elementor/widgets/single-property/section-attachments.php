                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="property-document-link<?php echo ($documents_download == 1 && !is_user_logged_in()) ? ' login-link' : ''; ?>">
                                        ...
                                        <?php if( $documents_download == 1 ) {
                                            ...
                                            <a download="<?php echo esc_attr( $attachment_meta->post_title ); ?>" rel="noopener" href="<?php echo esc_url( $attachment_meta->guid ); ?>" target="_blank"><?php echo $download_text; ?></a>
                                            <?php } else { ?>
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#login-register-form"><?php echo $download_text; ?></a>
                                            <?php } ?>
                                        <?php } else { ?>
                                            <a download="<?php echo esc_attr( $attachment_meta->post_title ); ?>" rel="noopener" href="<?php echo esc_url( $attachment_meta->guid ); ?>" target="_blank"><?php echo $download_text; ?></a>
                                        <?php } ?>
