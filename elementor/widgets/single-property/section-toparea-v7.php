...
class Property_Toparea_v7 extends Widget_Base {
	...
	protected function render() {
                ...
                <div class="property-banner">
                    <div class="d-block d-md-none">
                        ...
                        <?php if( $gallery_type == 'photoswipe' ) {?> 
                            <div>
                                <a href="#" class="property-banner-trigger position-absolute top-0 start-0 w-100 h-100" data-src="<?php echo esc_url($featured_image_url); ?>" data-houzez-fancybox data-fancybox="gallery-mobile-<?php echo esc_attr($token); ?>"></a>
                                <?php
                                if(!empty($mobile_images_ids)) {
                                    foreach( $mobile_images_ids as $image_id ) {
                                        ...
                                        <div class="gallery-hidden">
                                            <a href="#" data-src="<?php echo esc_url($image_url); ?>" data-houzez-fancybox data-fancybox="gallery-mobile-<?php echo esc_attr($token); ?>">
                                ...
                                foreach( $images_ids as $image_id ) {
                                    ...
                                    <div class="hs-gallery-v5-grid-item hs-gallery-v5-grid-item-01">
                                        <div class="property-banner-item">
                                            <a data-slider-no="<?php echo esc_attr($i); ?>" data-image="<?php echo esc_attr($j); ?>" <?php echo $dataModal; ?> class="img-wrap-1 <?php echo esc_attr($css_class); ?>">
                                                <img class="img-fluid" src="<?php echo esc_url($image_url); ?>" alt="<?php echo esc_attr($image_alt); ?>">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <?php } else { ?>
                                        <div class="gallery-hidden">
                                            <a data-slider-no="<?php echo esc_attr($i); ?>" data-image="<?php echo esc_attr($j); ?>" <?php echo $dataModal; ?>>
                                                <img class="img-fluid" src="<?php echo esc_url($image_url); ?>" alt="<?php echo esc_attr($image_alt); ?>">
                                            </a>
                                        </div>
                                    <?php } 
        ...
        <?php 
        htf_get_template_part('elementor/template-part/single-property/mobile', 'view', array('media_tabs' => false));
