                        ...
                        <div class="hs-gallery-v5-grid">
                            ...
                            foreach( $images_ids as $image_id ) {
                                ...
                                <div class="hs-gallery-v5-grid-item hs-gallery-v5-grid-item-01">
                                    <a <?php echo $dataModal; ?> data-slider-no="<?php echo esc_attr($i); ?>" data-image="<?php echo esc_attr($j); ?>" class="img-wrap-1 <?php echo esc_attr($css_class);?>">
                                ...
                                <?php } ?>
                                    <a <?php echo $dataModal; ?> data-slider-no="<?php echo esc_attr($i); ?>" data-image="<?php echo esc_attr($j); ?>" class="img-wrap-<?php echo esc_attr($i); ?> <?php echo esc_attr($css_class);?>">
                                ...
                                <?php } ?>
                                <?php } else { ?>
                                    <a <?php echo $dataModal; ?> data-slider-no="<?php echo esc_attr($i); ?>" data-image="<?php echo esc_attr($j); ?>" class="img-wrap-1 gallery-hidden">
                                        <img class="img-fluid" src="<?php echo esc_url($image_data[0] ?? ''); ?>" alt="<?php echo esc_attr($image_data[1]); ?>">
                                    </a>
                                <?php
                                }
