                ...
                <div class="tab-content" id="pills-tabContent" role="tablist">
                    <div class="tab-pane show active" id="pills-gallery" role="tabpanel" aria-labelledby="pills-gallery-tab" aria-hidden="false">
                        ...
                        if( $gallery_type == 'photoswipe' ) { 
                            ?>
                            <div>
                                <a href="#" class="property-banner-trigger position-absolute top-0 start-0 w-100 h-100" data-src="<?php echo esc_url($featured_image_url); ?>" data-houzez-fancybox data-fancybox="gallery-v1" role="button"></a>
                                ...
                                if(!empty($images_ids)) {
                                    foreach( $images_ids as $image_id ) {
                                        ...
                                        <div class="gallery-hidden">
                                            <a href="#" data-src="<?php echo esc_url($image_url); ?>" data-houzez-fancybox data-fancybox="gallery-v1">
