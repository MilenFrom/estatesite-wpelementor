	...
	protected function register_controls() {
       ...
       $this->houzez_single_property_section_styling_traits();
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .block-content-wrap li span, .block-content-wrap li span a' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .block-content-wrap .detail-wrap li .list-lined-item' => 'border-bottom-style: {{VALUE}};',
                    '{{WRAPPER}} .additional-details-ul li .list-lined-item' => 'border-bottom-style: {{VALUE}};',
                ],
            ]
        );
       ...
       $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .block-content-wrap .detail-wrap li .list-lined-item' => 'border-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .additional-details-ul li .list-lined-item' => 'border-color: {{VALUE}}',
                ],
            ]
        );
