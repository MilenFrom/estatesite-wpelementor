                        ...
                        <div class="hs-gallery-v4-grid">
                            ...
                            foreach( $images_ids as $image_id ) {
                                ...
                                <div class="hs-gallery-v4-grid-item hs-gallery-v4-grid-item-01">
                                    <a <?php echo $dataModal; ?> data-slider-no="<?php echo esc_attr($i); ?>" class="img-wrap-1 <?php echo esc_attr($css_class);?>">
                                ...
                                <?php } ?>
                                    <a <?php echo $dataModal; ?> data-slider-no="<?php echo esc_attr($i); ?>" class="img-wrap-<?php echo esc_attr($i); ?> <?php echo esc_attr($css_class);?>">
                                        <img class="img-fluid" src="<?php echo esc_url($image_data[0]); ?>" alt="<?php echo esc_attr($image_data[1]); ?>">
                                    </a>
                                ...
                                <?php } ?>
                                <?php } else { ?>
                                    <a <?php echo $dataModal; ?> data-slider-no="<?php echo esc_attr($i); ?>" class="img-wrap-1 gallery-hidden">
                                        <img class="img-fluid" src="<?php echo esc_url($image_data[0]); ?>" alt="<?php echo esc_attr($image_data[1]); ?>">
                                    </a>
                                <?php
                                }
