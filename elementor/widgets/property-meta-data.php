...
class Houzez_Property_Meta_Data extends Widget_Base {
	...
	protected function houzez_meta_field($settings)
	{
	    ...
	    switch ($meta_field) {
	        case 'property_size':
	            ...
	            $field_label = $field_label . ' ' . houzez_get_listing_size_unit($post->ID);
	            break;
	        case 'property_land':
	            $field_data = houzez_get_land_area_size($post->ID);
	            $field_label = $field_label . ' ' . houzez_get_land_size_unit($post->ID);
	            break;
            case 'property_price':
    ...
    private function get_price_placeholder_value($listing_id) {
        $price_placeholder = \EstateSite\Core\Property::get( $listing_id, 'price_placeholder' );
    ...
    private function houzez_meta_price($settings = array()) {
        ...
        $output = '';
        $sale_price     = \EstateSite\Core\Property::get( $listing_id, 'price' );
        $second_price     = \EstateSite\Core\Property::get( $listing_id, 'sec_price' );
        $price_postfix  = \EstateSite\Core\Property::get( $listing_id, 'price_postfix' );
        $price_prefix  = \EstateSite\Core\Property::get( $listing_id, 'price_prefix' );
