...
class Houzez_Agent_Call_Button extends Widget_Base {
	...
	protected function render() {
        ...
        $agent_number = get_post_meta( get_the_ID(), 'fave_agent_mobile', true ) /* TODO unmapped fave_ key: fave_agent_mobile */;
        $agent_number_call = str_replace(array('(',')',' ','-'),'', $agent_number);
        if( empty($agent_number) ) {
            $agent_number = get_post_meta( get_the_ID(), 'fave_agent_office_num', true ) /* TODO unmapped fave_ key: fave_agent_office_num */;
            $agent_number_call = str_replace(array('(',')',' ','-'),'', $agent_number);
        }
