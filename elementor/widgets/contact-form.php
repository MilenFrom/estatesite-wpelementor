...
class Houzez_Elementor_Contact_Form extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Captcha', 'houzez-theme-functionality' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'houzez-theme-functionality' ),
                'label_off' => esc_html__( 'Hide', 'houzez-theme-functionality' ),
                'default' => 'false',
                'description' => esc_html__( 'Please make sure you have enabled captcha in Theme Options -> Google reCaptcha and have added the API keys', 'houzez-theme-functionality' ),
                'separator' => 'before',
            ]
        );
    ...
    protected function render() {
        ...
        <form class="elementor-form houzez-ele-form-js" id="houzez-form-<?php echo esc_attr($this->get_id()); ?>" method="post" <?php echo $this->get_render_attribute_string( 'form' ); ?> action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>">
            ...
            <div <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>
                ...
                foreach ( $settings['form_fields'] as $item_index => $item ) :
                    ...
                    <?php if( isset($settings['gdpr_agreement']) && $settings['gdpr_agreement'] == 'yes') { 
                        $gdpr_validate = isset($settings['gdpr_validate']) && ! empty($settings['gdpr_validate']) ? $settings['gdpr_validate'] : '* '.esc_attr($settings['gdpr_text']);
                    ?>
                    ...
                    <?php do_action('houzez_after_elementor_contact_form_fields'); ?>
