...
class Houzez_Agency_Call_Button extends Widget_Base {
	...
	protected function render() {
        ...
        $agency_number = get_post_meta( get_the_ID(), 'fave_agency_phone', true ) /* TODO unmapped fave_ key: fave_agency_phone */;
        $agency_number_call = str_replace(array('(',')',' ','-'),'', $agency_number);
        if( empty($agency_number) ) {
            $agency_number = get_post_meta( get_the_ID(), 'fave_agency_mobile', true ) /* TODO unmapped fave_ key: fave_agency_mobile */;
            $agency_number_call = str_replace(array('(',')',' ','-'),'', $agency_number);
        }
