...
class Houzez_Menu extends Widget_Base {
    ...
    protected function render() {
		...
		<div class="houzez-ele-mobile-menu-<?php echo esc_attr( $this->get_id() ); ?> nav-mobile houzez-show-menu-<?php echo esc_attr($mobile_menu_breakpoint); ?> <?php echo esc_attr($show_desktop); ?>">
			...
			<div class="houzez-menu-toggle-button" role="button" tabindex="0" aria-label="<?php echo esc_attr__('Open menu', 'houzez-theme-functionality'); ?>" data-bs-toggle="offcanvas" data-bs-target="#hz-offcanvas-ele-menu-<?php echo esc_attr($token);?>" aria-controls="hz-offcanvas-ele-menu-<?php echo esc_attr($token);?>" aria-expanded="false">
				<?php
