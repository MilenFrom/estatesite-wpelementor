...
class Houzez_Post_Info extends Widget_Base {
	...
	protected function render() {
		...
		<style>
			.elementor-widget .houzez-post-info .elementor-icon-list-item, .elementor-widget .houzez-post-info .elementor-icon-list-item a {
				align-items: var(--icon-vertical-align, center);
				display: flex;
				font-size: inherit;
			}

			.elementor-widget .houzez-post-info .elementor-icon-list-icon {    
				display: flex;
				position: relative;
				top: var(--icon-vertical-offset, initial);
			}

			.elementor-widget .houzez-post-info.elementor-icon-list-items.elementor-inline-items {
				display: flex;
				flex-wrap: wrap;
				margin-left: -8px;
				margin-right: -8px;
			...
			.elementor-widget .houzez-post-info.elementor-icon-list-items {
				list-style-type: none;
				margin: 0;
				padding: 0;
			}

			.elementor-widget .houzez-post-info.elementor-icon-list-items.elementor-inline-items .elementor-icon-list-item {
				margin-left: 8px;
				margin-right: 8px;
			}

			.elementor-widget .houzez-post-info.elementor-icon-list-items.elementor-inline-items .elementor-inline-item {
				word-break: break-word;
			}

			.elementor-widget .houzez-post-info .elementor-icon-list-item {
				margin: 0;
				padding: 0;
				position: relative;
			}
			.elementor-widget .houzez-post-info .elementor-icon-list-icon+.elementor-icon-list-text {
				align-self: center;
				padding-inline-start: 5px;
			}
			.houzez-post-info.elementor-icon-list-items .elementor-icon-list-item .elementor-icon-list-text {
