    ...
    protected function render() {
        ...
        <div class="banner-image-module d-flex justify-content-center align-items-center">
            ...
            if( $image_size ) {
                ...
                $banner_image_alt = get_post_meta($image_id, '_wp_attachment_image_alt', true);
                if (empty($banner_image_alt)) {
                    $banner_image_alt = get_the_title();
                }
                echo '<img class="img-fluid" src="' . esc_url($image_size) . '" alt="' . esc_attr($banner_image_alt) . '">';
            }
            ?>
