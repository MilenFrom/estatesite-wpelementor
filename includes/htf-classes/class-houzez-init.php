...
class Houzez {
    ...
    */
    ...
    public static function houzez_plugin_activation()
    {
        ...
        // Schedule saved search email alerts based on theme settings
        // Only schedule ONE event based on the duration setting to prevent duplicate emails
        $saved_search_duration = get_option('houzez_save_search_duration', 'daily');
