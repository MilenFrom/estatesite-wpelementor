...
class Houzez_Post_Type_Packages {
    ...
    public static function user_packages_populate_columns($column){
        ...
        $pack_billing_period = get_post_meta( $pack_id, 'fave_billing_time_unit', true ) /* TODO unmapped fave_ key: fave_billing_time_unit */;
        $pack_billing_frequency = get_post_meta( $pack_id, 'fave_billing_unit', true ) /* TODO unmapped fave_ key: fave_billing_unit */;
