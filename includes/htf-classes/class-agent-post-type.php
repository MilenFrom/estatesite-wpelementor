...
class Houzez_Post_Type_Agent {
    ...
    public static function custom_columns_manage( $column ) {
        ...
        switch ( $column ) {
            ...
            case 'category':
                ...
                break;
            case 'email':
                $email = get_post_meta( get_the_ID(),  'fave_agent_email', true ) /* TODO unmapped fave_ key: fave_agent_email */;
                ...
                break;
            case 'web':
                $web = get_post_meta( get_the_ID(), 'fave_agent_website', true ) /* TODO unmapped fave_ key: fave_agent_website */;
                ...
                break;
            case 'mobile':
                $phone = get_post_meta( get_the_ID(), 'fave_agent_mobile', true ) /* TODO unmapped fave_ key: fave_agent_mobile */;
    ...
    public static function save_agent_meta($post_id, $post, $update) {
        ...
        update_post_meta( $post_id, 'fave_agent_company', $fave_agent_company) /* TODO unmapped fave_ key: fave_agent_company */ ;
