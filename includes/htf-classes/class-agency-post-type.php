    ...
    public static function custom_columns_manage( $column ) {
        switch ( $column ) {
            ...
            case 'agency_id':
                ...
                break;
            case 'license':
                $agency_licenses = get_post_meta( get_the_ID(),  'fave_agency_licenses', true ) /* TODO unmapped fave_ key: fave_agency_licenses */;
                ...
                break;
            case 'email':
                $email = get_post_meta( get_the_ID(),  'fave_agency_email', true ) /* TODO unmapped fave_ key: fave_agency_email */;
                ...
                break;
            case 'web':
                $web = get_post_meta( get_the_ID(), 'fave_agency_web', true ) /* TODO unmapped fave_ key: fave_agency_web */;
                ...
                break;
            case 'phone':
                $phone = get_post_meta( get_the_ID(), 'fave_agency_phone', true ) /* TODO unmapped fave_ key: fave_agency_phone */;
